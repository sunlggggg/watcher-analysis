...
public class Fwlog {
    ...
    @Basic
    @Column(name = "anotherTimestamp")
    private Date anotherTimestamp;

    @Basic
    @Column(name = "mathedStrategy")
    private String mathedStrategy;

    @Basic
    @Column(name = "originalSrcIp")
    private String originalSrcIp;

    @Basic
    @Column(name = "originalSrcPort")
    private String originalSrcPort;

    @Basic
    @Column(name = "originalDestIP")
    private String originalDestIp;

    @Basic
    @Column(name = "originalDestPort")
    private String originalDestPort;

    @Basic
    @Column(name = "convertedSrcIP")
    private String convertedSrcIp;

    @Basic
    @Column(name = "convertedSrcPort")
    private String convertedSrcPort;

    @Basic
    @Column(name = "convertedDestIp")
    private String convertedDestIp;

    @Basic
    @Column(name = "convertedDestPort")
